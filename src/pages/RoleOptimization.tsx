...
const RoleOptimization = () => {
  ...
  const roleOptions: RoleOption[] = (roleDetails ?? [])
  .filter((r) => !selectedLicense || r.classification === selectedLicense)
  .map((r) => ({
    value: r.profile,
    label: r.profile,
    description: r.description,
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) => {
  setSelectedLicense(v);
  setSelectedRoles([]);   // clear roles that may no longer be in the filtered list
}}
